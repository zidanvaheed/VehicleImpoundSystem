            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-button">
                        <p><a href="../order2.php" class="btn btn-primary" >Back&nbsp;&nbsp;&nbsp;&nbsp;</a></p> 
                        <?php
                        echo '<a href="orderdelete4.php?item_id='. $row['item_id'] .'" class="btn btn-danger">Delete</a>';
                        ?>
                        <?php
                        echo '<a href="orderupdate4.php?item_id='. $row['item_id'] .'" class="btn btn-danger">Update</a>';
                        ?>
                    </div>              
                </div>
            </div>        
